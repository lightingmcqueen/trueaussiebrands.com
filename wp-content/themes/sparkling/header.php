...
<?php wp_head(); ?>
<style type='text/css'>img#wpstats{display:none}</style><style type="text/css">.entry-content {font-family: Open Sans; font-size:14px; font-weight: normal; color:#6B6B6B;}.osc_servicebox .fa {
  font-size: 40px;
  padding: 40px;
  background: #DA4453;
  border-radius: 50%;
